...
public class fsdf_MassDamageOnHit implements OnHitEffectPlugin {
	...
	public void onHit(DamagingProjectileAPI projectile, CombatEntityAPI target,
      ...
      float damageModifier = (mass / 1000) + (float)(8.5 / Math.sqrt(mass));  // Calculate the damage modifier. Thanks Owen for the equation <3
      ...
      float newDamage = damage * damageModifier;                              // Calculate the new damage based on the damage modifier.
            Math.min(damageModifier, 10);                                   // Stop damage getting too high.

      //Get location, velocity and deal damage. God this was a pain in the ass to work out.
      ...
      float ExpSize = newDamage / 5f;
            Math.min(ExpSize, 1000);  // Stop the FX getting too big. No more screen wide nukes lol.

      engine.spawnExplosion(point, vel, new Color(255, 125, 50), ExpSize, 1f);  //SFX Stuff.
    }
  }
}