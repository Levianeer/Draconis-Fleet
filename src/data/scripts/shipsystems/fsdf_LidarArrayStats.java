...
public class fsdf_LidarArrayStats extends BaseShipSystemScript {
	...
	public static float PASSIVE_RANGE_BONUS = 20f;
	...
	protected List<LidarDishData> dishData = new ArrayList<fsdf_LidarArrayStats.LidarDishData>();
