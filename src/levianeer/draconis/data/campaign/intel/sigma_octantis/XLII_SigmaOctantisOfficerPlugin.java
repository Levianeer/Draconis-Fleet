package levianeer.draconis.data.campaign.intel.sigma_octantis;
...
public class XLII_SigmaOctantisOfficerPlugin implements AICoreOfficerPlugin {
    ...
    public PersonAPI createPerson(String aiCoreId, String factionId, Random random) {
        ...
        person.getMemoryWithoutUpdate().set(AUTOMATED_POINTS_MULT, 1f);
    ...
    public void createPersonalitySection(PersonAPI person, TooltipMakerAPI tooltip) {
        tooltip.addPara(
            "The Alliance Intelligence Office has given three standing orders regarding this device. The first is classified. "
