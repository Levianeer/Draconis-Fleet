...
public class XLII_FafnirSystemMonitor implements EveryFrameScript {
    ...
    public void advance(float amount) {
        ...
        if (!isFleetAliveInFafnir(interceptingFleet, fafnir)) {
            ...
            // If this is a HighCommand patrol fleet, save its home entity so we can
            // restore the patrol assignment after the intercept ends.
    ...
    /**
     * Returns the nearest untaged DDA military fleet in the Fafnir system to the player,
