...
public class XLII_LidarArrayStats extends BaseShipSystemScript {

    public static String LIDAR_WINDUP = "lidar_windup";

    public static Color WEAPON_GLOW = new Color(255, 0, 0, 181);
    ...
    protected java.util.List<levianeer.draconis.data.scripts.shipsystems.XLII_LidarArrayStats.LidarDishData> dishData = new ArrayList<>();
    ...
    public void init(ShipAPI ship) {
        ...
        for (WeaponAPI w : lidar) {
            if (w.isDecorative() && w.getSpec().hasTag(Tags.LIDAR)) {
                ...
                levianeer.draconis.data.scripts.shipsystems.XLII_LidarArrayStats.LidarDishData data = new levianeer.draconis.data.scripts.shipsystems.XLII_LidarArrayStats.LidarDishData();
    ...
    protected void modify(String id, MutableShipStatsAPI stats, float effectLevel) {
        ...
        stats.getMaxSpeed().modifyPercent(id, SPEED_DEBUFF);
        stats.getAcceleration().modifyPercent(id, SPEED_DEBUFF);
        stats.getDeceleration().modifyPercent(id, SPEED_DEBUFF);
    }
    ...
    public StatusData getStatusData(int index, State state, float effectLevel) {
        ...
        if (index == 4) {
            return new StatusData("maneuverability   " + (int) SPEED_DEBUFF + "%", true);
        }
