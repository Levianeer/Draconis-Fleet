...
public class XLII_CulverinOnHitEffect implements OnHitEffectPlugin {
    ...
    private static final String SOUND_ID = "XLII_culverin_proxy_explosion";
    ...
    private void spawnExplosionEffects(CombatEngineAPI engine, Vector2f point, Vector2f velocity) {
        engine.spawnExplosion(point, velocity, COLOR_FRINGE, 9f, 0.6f);
        engine.spawnExplosion(point, velocity, COLOR_CORE, 6f, 0.6f);
        engine.addNegativeNebulaParticle(point, velocity, 3f, 2f, 0f, 0f, 0.5f, COLOR_GLOW);
    }
    ...
    private void spawnDebris(CombatEngineAPI engine, CombatEntityAPI target, Vector2f point, Vector2f velocity) {
        ...
        engine.spawnDebrisSmall(point, velocity, 6, direction, DEBRIS_ARC, 2f, 2f, 720f);
        engine.spawnDebrisMedium(point, velocity, 3, direction, DEBRIS_ARC, 1f, 2f, 360f);
        engine.spawnDebrisLarge(point, velocity, 1, direction, DEBRIS_ARC, 1f, 1f, 180f);
    }
