...
public class fsdf_SystemBurnOnHitEffect extends BaseCombatLayeredRenderingPlugin implements OnHitEffectPlugin {
    ...
    public static final String STATUS_KEY = "fsdf_system_burn"; // Unique key for the status effect
    private static final String STATUS_REGISTERED_KEY = "fsdf_burn_status_registered";
