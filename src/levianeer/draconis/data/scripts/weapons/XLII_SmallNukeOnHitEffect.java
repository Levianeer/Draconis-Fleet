...
public class XLII_SmallNukeOnHitEffect implements OnHitEffectPlugin {
    ...
    private static DamagingExplosionSpec createCachedVisualExplosionSpec() {
        ...
        spec.setDetailedExplosionRadius(125f);
        spec.setDetailedExplosionFlashRadius(175f);
    ...
    private static void spawnLensFlares(CombatEngineAPI engine, ShipAPI source, Vector2f center) {
        ...
        final float flareRange = 50f;

        for (int i = 3; i < flareCount; i++) {
    ...
    private static void spawnNuclearShockwave(CombatEngineAPI engine, Vector2f point) {
        ...
        float startSize = 37.5f;
        float finalSize = 225f;
        float intensity = 75f;
        float duration = 0.4f;
