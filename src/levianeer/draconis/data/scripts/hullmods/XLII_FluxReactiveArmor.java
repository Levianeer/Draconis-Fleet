...
public class XLII_FluxReactiveArmor extends BaseHullMod {
    ...
    private static final float FLUX_CONVERSION = 0.5f;
    ...
    public void addPostDescriptionSection(TooltipMakerAPI tooltip, HullSize hullSize, ShipAPI ship, float width, boolean isForModSpec) {
        ...
        tooltip.addPara(
                "Reduces all hull damage taken by %s. In exchange %s of the original damage is converted into hard flux.",
    ...
    private static class FluxReactiveArmorListener implements HullDamageAboutToBeTakenListener {
        ...
        public boolean notifyAboutToTakeHullDamage(Object param, ShipAPI ship, Vector2f point, float damageAmount) {
            float reducedDamage = (float) Math.max(1f, Math.ceil(damageAmount * (1f - HULL_DAMAGE_REDUCTION)));
            ...
            ship.getFluxTracker().increaseFlux(damageAmount * FLUX_CONVERSION, true);
