...
public class XLII_antiMissileAI implements MissileAIPlugin, GuidedMissileAI {
                ...
                for (MissileAPI m : near) {
                    ...
                    if (m.getOwner() == missile.getOwner()) {
                        if (m.getWeaponSpec() != null && m.getWeaponSpec().getWeaponId().equals(missile.getWeaponSpec().getWeaponId())) {
                            if (m.getMissileAI() instanceof XLII_antiMissileAI) {
                                XLII_antiMissileAI ai = (XLII_antiMissileAI) m.getMissileAI();
