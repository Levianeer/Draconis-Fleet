...
public class fsdf_antiMissileAI implements MissileAIPlugin, GuidedMissileAI {
    ...
    public fsdf_antiMissileAI(MissileAPI missile, ShipAPI launchingShip) {
                ...
                for (MissileAPI m : near) {
                    ...
                    if (m.getOwner() == missile.getOwner()) {
                        if (m.getWeaponSpec() != null && m.getWeaponSpec().getWeaponId().equals(missile.getWeaponSpec().getWeaponId())) {
                            if (m.getMissileAI() instanceof fsdf_antiMissileAI) {
                                fsdf_antiMissileAI ai = (fsdf_antiMissileAI) m.getMissileAI();
