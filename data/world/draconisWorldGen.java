...
public class draconisWorldGen implements SectorGeneratorPlugin {
	...
	public static void initFactionRelationships(SectorAPI sector) {
		...
		XLII_draconis.setRelationship(Factions.HEGEMONY, RepLevel.SUSPICIOUS);
		XLII_draconis.setRelationship(Factions.PERSEAN, RepLevel.SUSPICIOUS);
		XLII_draconis.setRelationship(Factions.INDEPENDENT, RepLevel.NEUTRAL);
		XLII_draconis.setRelationship(Factions.TRITACHYON, RepLevel.FAVORABLE);
		...
		XLII_draconis.setRelationship(Factions.LUDDIC_CHURCH, RepLevel.SUSPICIOUS);
		XLII_draconis.setRelationship(Factions.DIKTAT, RepLevel.HOSTILE);
