package data.missions.old_dawn;
...
public class MissionDefinition implements MissionDefinitionPlugin {
	...
	public void defineMission(MissionDefinitionAPI api) {
		...
		api.addToFleet(FleetSide.PLAYER, "onslaught_Elite", FleetMemberType.SHIP, true);	// 40	// Total : 200
		api.addToFleet(FleetSide.PLAYER, "onslaught_Elite", FleetMemberType.SHIP, true);	// 40
		api.addToFleet(FleetSide.PLAYER, "onslaught_Elite", FleetMemberType.SHIP, true);	// 40
		api.addToFleet(FleetSide.PLAYER, "onslaught_Elite", FleetMemberType.SHIP, true);	// 40
		api.addToFleet(FleetSide.PLAYER, "onslaught_Elite", FleetMemberType.SHIP, true);	// 40
